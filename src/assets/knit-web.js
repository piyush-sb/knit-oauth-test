 ...
 */
const Ct = window, ze = Ct.ShadowRoot && (Ct.ShadyCSS === void 0 || Ct.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ee = Symbol(), Be = /* @__PURE__ */ new WeakMap();
class kr {
  constructor(e, r, o) {
    if (this._$cssResult$ = !0, o !== Ee)
  ...
  get styleSheet() {
    ...
    if (ze && e === void 0) {
      ...
      o && (e = Be.get(r)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && Be.set(r, e));
    }
    return e;
  }
  toString() {
...
const Ar = (t) => new kr(typeof t == "string" ? t : t + "", void 0, Ee), bt = (t, ...e) => {
  ...
  return new kr(r, t, Ee);
}, uo = (t, e) => {
  ze ? t.adoptedStyleSheets = e.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet) : e.forEach((r) => {
    const o = document.createElement("style"), a = Ct.litNonce;
 ...
 */
var ie;
const Rt = window, Ye = Rt.trustedTypes, ho = Ye ? Ye.emptyScript : "", He = Rt.reactiveElementPolyfillSupport, be = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? ho : null;
      break;
  ...
  return r;
} }, Dr = (t, e) => e !== t && (e == e || t == t), ne = { attribute: !0, type: String, converter: be, reflect: !1, hasChanged: Dr };
class rt extends HTMLElement {
  ...
  _$EO(e, r, o = ne) {
    ...
    if (i !== void 0 && o.reflect === !0) {
      const n = (((a = o.converter) === null || a === void 0 ? void 0 : a.toAttribute) !== void 0 ? o.converter : be).toAttribute(r, o.type);
  ...
  _$AK(e, r) {
    ...
    if (i !== void 0 && this._$El !== i) {
      const n = a.getPropertyOptions(i), s = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((o = n.converter) === null || o === void 0 ? void 0 : o.fromAttribute) !== void 0 ? n.converter : be;
      this._$El = i, this[i] = s.fromAttribute(r, n.type), this._$El = null;
    }
  }
  requestUpdate(e, r, o) {
    let a = !0;
    e !== void 0 && (((o = o || this.constructor.getPropertyOptions(e)).hasChanged || Dr)(this[e], r) ? (this._$AL.has(e) || this._$AL.set(e, r), o.reflect === !0 && this._$El !== e && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(e, o))) : a = !1), !this.isUpdatePending && a && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
rt.finalized = !0, rt.elementProperties = /* @__PURE__ */ new Map(), rt.elementStyles = [], rt.shadowRootOptions = { mode: "open" }, He == null || He({ ReactiveElement: rt }), ((ie = Rt.reactiveElementVersions) !== null && ie !== void 0 ? ie : Rt.reactiveElementVersions = []).push("1.5.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var se;
const Pt = window, nt = Pt.trustedTypes, Ve = nt ? nt.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Q = `lit$${(Math.random() + "").slice(9)}$`, Mr = "?" + Q, vo = `<${Mr}>`, st = document, yt = (t = "") => st.createComment(t), kt = (t) => t === null || typeof t != "object" && typeof t != "function", zr = Array.isArray, xo = (t) => zr(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", ht = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, qe = /-->/g, We = />/g, J = RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ke = /'/g, Je = /"/g, Er = /^(?:script|style|textarea|title)$/i, wo = (t) => (e, ...r) => ({ _$litType$: t, strings: e, values: r }), u = wo(1), G = Symbol.for("lit-noChange"), M = Symbol.for("lit-nothing"), Ge = /* @__PURE__ */ new WeakMap(), ot = st.createTreeWalker(st, 129, null, !1), yo = (t, e) => {
  ...
  for (let d = 0; d < r; d++) {
    ...
    for (; h < l.length && (n.lastIndex = h, c = n.exec(l), c !== null); )
      h = n.lastIndex, n === ht ? c[1] === "!--" ? n = qe : c[1] !== void 0 ? n = We : c[2] !== void 0 ? (Er.test(c[2]) && (a = RegExp("</" + c[2], "g")), n = J) : c[3] !== void 0 && (n = J) : n === J ? c[0] === ">" ? (n = a != null ? a : ht, g = -1) : c[1] === void 0 ? g = -2 : (g = n.lastIndex - c[2].length, m = c[1], n = c[3] === void 0 ? J : c[3] === '"' ? Je : Ke) : n === Je || n === Ke ? n = J : n === qe || n === We ? n = ht : (n = J, a = void 0);
    const b = n === J && t[d + 1].startsWith("/>") ? " " : "";
    i += n === ht ? l + vo : g >= 0 ? (o.push(m), l.slice(0, g) + "$lit$" + l.slice(g) + Q + b) : l + Q + (g === -2 ? (o.push(void 0), d) : b);
  }
  const s = i + (t[r] || "<?>") + (e === 2 ? "</svg>" : "");
  if (!Array.isArray(t) || !t.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return [Ve !== void 0 ? Ve.createHTML(s) : s, o];
};
class At {
  constructor({ strings: e, _$litType$: r }, o) {
    ...
    this.parts = [];
    let i = 0, n = 0;
    const s = e.length - 1, d = this.parts, [l, m] = yo(e, r);
    if (this.el = At.createElement(l, o), ot.currentNode = this.el.content, r === 2) {
      const c = this.el.content, g = c.firstChild;
      g.remove(), c.append(...g.childNodes);
    }
    for (; (a = ot.nextNode()) !== null && d.length < s; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) {
          const c = [];
          for (const g of a.getAttributeNames())
            if (g.endsWith("$lit$") || g.startsWith(Q)) {
              const h = m[n++];
              if (c.push(g), h !== void 0) {
                const b = a.getAttribute(h.toLowerCase() + "$lit$").split(Q), v = /([.?@])?(.*)/.exec(h);
                d.push({ type: 1, index: i, name: v[2], strings: b, ctor: v[1] === "." ? Ao : v[1] === "?" ? Mo : v[1] === "@" ? zo : Vt });
              } else
        ...
        if (Er.test(a.tagName)) {
          const c = a.textContent.split(Q), g = c.length - 1;
          if (g > 0) {
            a.textContent = nt ? nt.emptyScript : "";
            for (let h = 0; h < g; h++)
              a.append(c[h], yt()), ot.nextNode(), d.push({ type: 2, index: ++i });
            a.append(c[g], yt());
          }
        }
  ...
  static createElement(e, r) {
    const o = st.createElement("template");
    return o.innerHTML = e, o;
  }
}
function lt(t, e, r = t, o) {
  var a, i, n, s;
  if (e === G)
    return e;
  let d = o !== void 0 ? (a = r._$Co) === null || a === void 0 ? void 0 : a[o] : r._$Cl;
  const l = kt(e) ? void 0 : e._$litDirective$;
  return (d == null ? void 0 : d.constructor) !== l && ((i = d == null ? void 0 : d._$AO) === null || i === void 0 || i.call(d, !1), l === void 0 ? d = void 0 : (d = new l(t), d._$AT(t, r, o)), o !== void 0 ? ((n = (s = r)._$Co) !== null && n !== void 0 ? n : s._$Co = [])[o] = d : r._$Cl = d), d !== void 0 && (e = lt(t, d._$AS(t, e.values), d, o)), e;
}
class ko {
  constructor(e, r) {
  ...
  v(e) {
    var r;
    const { el: { content: o }, parts: a } = this._$AD, i = ((r = e == null ? void 0 : e.creationScope) !== null && r !== void 0 ? r : st).importNode(o, !0);
    ot.currentNode = i;
    let n = ot.nextNode(), s = 0, d = 0, l = a[0];
    for (; l !== void 0; ) {
      if (s === l.index) {
        let m;
        l.type === 2 ? m = new St(n, n.nextSibling, this, e) : l.type === 1 ? m = new l.ctor(n, l.name, l.strings, this, e) : l.type === 6 && (m = new Eo(n, this, e)), this.u.push(m), l = a[++d];
      }
      s !== (l == null ? void 0 : l.index) && (n = ot.nextNode(), s++);
    }
    return i;
  }
  p(e) {
...
class St {
  ...
  _$AI(e, r = this) {
    e = lt(this, e, r), kt(e) ? e === M || e == null || e === "" ? (this._$AH !== M && this._$AR(), this._$AH = M) : e !== this._$AH && e !== G && this.g(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : xo(e) ? this.k(e) : this.g(e);
  }
  O(e, r = this._$AB) {
  ...
  g(e) {
    this._$AH !== M && kt(this._$AH) ? this._$AA.nextSibling.data = e : this.T(st.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: o, _$litType$: a } = e, i = typeof a == "number" ? this._$AC(e) : (a.el === void 0 && (a.el = At.createElement(a.h, this.options)), a);
    if (((r = this._$AH) === null || r === void 0 ? void 0 : r._$AD) === i)
      this._$AH.p(o);
    else {
      const n = new ko(i, this), s = n.v(this.options);
      n.p(o), this.T(s), this._$AH = n;
    }
  }
  _$AC(e) {
    let r = Ge.get(e.strings);
    return r === void 0 && Ge.set(e.strings, r = new At(e)), r;
  }
  k(e) {
    ...
    let o, a = 0;
    for (const i of e)
      a === r.length ? r.push(o = new St(this.O(yt()), this.O(yt()), this, this.options)) : o = r[a], o._$AI(i), a++;
...
class Vt {
  ...
  _$AI(e, r = this, o, a) {
    ...
    let n = !1;
    if (i === void 0)
      e = lt(this, e, r, 0), n = !kt(e) || e !== this._$AH && e !== G, n && (this._$AH = e);
    else {
      const s = e;
      let d, l;
      for (e = i[0], d = 0; d < i.length - 1; d++)
        l = lt(this, s[o + d], r, d), l === G && (l = this._$AH[d]), n || (n = !kt(l) || l !== this._$AH[d]), l === M ? e = M : e !== M && (e += (l != null ? l : "") + i[d + 1]), this._$AH[d] = l;
    }
    n && !a && this.j(e);
  }
  j(e) {
...
const Do = nt ? nt.emptyScript : "";
class Mo extends Vt {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(e) {
    e && e !== M ? this.element.setAttribute(this.name, Do) : this.element.removeAttribute(this.name);
  }
}
class zo extends Vt {
  constructor(e, r, o, a, i) {
  ...
  _$AI(e, r = this) {
    var o;
    if ((e = (o = lt(this, e, r, 0)) !== null && o !== void 0 ? o : M) === G)
      return;
...
Ze == null || Ze(At, St), ((se = Pt.litHtmlVersions) !== null && se !== void 0 ? se : Pt.litHtmlVersions = []).push("2.5.0");
const So = (t, e, r) => {
  var o, a;
  ...
  if (n === void 0) {
    ...
    i._$litPart$ = n = new St(e.insertBefore(yt(), s), s, void 0, r != null ? r : {});
  }
  return n._$AI(t), n;
};
/**
...
class D extends rt {
  ...
  update(e) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = So(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
D.finalized = !0, D._$litElement$ = !0, (le = globalThis.litElementHydrateSupport) === null || le === void 0 || le.call(globalThis, { LitElement: D });
const Xe = globalThis.litElementPolyfillSupport;
Xe == null || Xe({ LitElement: D });
((de = globalThis.litElementVersions) !== null && de !== void 0 ? de : globalThis.litElementVersions = []).push("3.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const E = (t) => (e) => typeof e == "function" ? ((r, o) => (customElements.define(r, o), o))(t, e) : ((r, o) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const No = (t, e) => e.kind === "method" && e.descriptor && !("value" in e.descriptor) ? { ...e, finisher(r) {
...
function Se(t) {
  ...
  if (!e && typeof navigator < "u" && (e = navigator.userAgent), e && e.headers && typeof e.headers["user-agent"] == "string" && (e = e.headers["user-agent"]), typeof e != "string")
    return !1;
  let r = To.test(e) && !$o.test(e) || !!t.tablet && _o.test(e);
...
const { toString: Nr } = Object.prototype, { getPrototypeOf: Ne } = Object, je = ((t) => (e) => {
  const r = Nr.call(e);
  return t[r] || (t[r] = r.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), F = (t) => (t = t.toLowerCase(), (e) => je(e) === t), qt = (t) => (e) => typeof e === t, { isArray: gt } = Array, Dt = qt("undefined");
function Co(t) {
  return t !== null && !Dt(t) && t.constructor !== null && !Dt(t.constructor) && Z(t.constructor.isBuffer) && t.constructor.isBuffer(t);
}
const jr = F("ArrayBuffer");
function Oo(t) {
  let e;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? e = ArrayBuffer.isView(t) : e = t && t.buffer && jr(t.buffer), e;
}
const Io = qt("string"), Z = qt("function"), Tr = qt("number"), Te = (t) => t !== null && typeof t == "object", Uo = (t) => t === !0 || t === !1, Ot = (t) => {
  if (je(t) !== "object")
    return !1;
  const e = Ne(t);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, Lo = F("Date"), Ro = F("File"), Po = F("Blob"), Fo = F("FileList"), Bo = (t) => Te(t) && Z(t.pipe), Qo = (t) => {
  const e = "[object FormData]";
  return t && (typeof FormData == "function" && t instanceof FormData || Nr.call(t) === e || Z(t.toString) && t.toString() === e);
}, Yo = F("URLSearchParams"), Ho = (t) => t.trim ? t.trim() : t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
function Nt(t, e, { allOwnKeys: r = !1 } = {}) {
...
const _r = (() => typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global)(), Cr = (t) => !Dt(t) && t !== _r;
function ge() {
  const { caseless: t } = Cr(this) && this || {}, e = {}, r = (o, a) => {
    const i = t && $r(e, a) || a;
    Ot(e[i]) && Ot(o) ? e[i] = ge(e[i], o) : Ot(o) ? e[i] = ge({}, o) : gt(o) ? e[i] = o.slice() : e[i] = o;
  };
  for (let o = 0, a = arguments.length; o < a; o++)
    arguments[o] && Nt(arguments[o], r);
  return e;
}
const Vo = (t, e, r, { allOwnKeys: o } = {}) => (Nt(e, (a, i) => {
  r && Z(a) ? t[i] = Sr(a, r) : t[i] = a;
}, { allOwnKeys: o }), t), qo = (t) => (t.charCodeAt(0) === 65279 && (t = t.slice(1)), t), Wo = (t, e, r, o) => {
  ...
  for (; e-- > 0; )
    r[e] = t[e];
  return r;
}, Zo = ((t) => (e) => t && e instanceof t)(typeof Uint8Array < "u" && Ne(Uint8Array)), Xo = (t, e) => {
  ...
  for (; (r = t.exec(e)) !== null; )
    o.push(r);
  return o;
}, ea = F("HTMLFormElement"), ra = (t) => t.toLowerCase().replace(
  /[_-\s]([a-z\d])(\w*)/g,
  function(r, o, a) {
    return o.toUpperCase() + a;
  }
), tr = (({ hasOwnProperty: t }) => (e, r) => t.call(e, r))(Object.prototype), oa = F("RegExp"), Or = (t, e) => {
  ...
  return gt(t) ? o(t) : o(String(t).split(e)), r;
}, na = () => {
}, sa = (t, e) => (t = +t, Number.isFinite(t) ? t : e), la = (t) => {
...
Object.defineProperties(w, Ur);
Object.defineProperty(Ir, "isAxiosError", { value: !0 });
w.from = (t, e, r, o, a, i) => {
  const n = Object.create(Ir);
...
var da = typeof self == "object" ? self.FormData : window.FormData;
const pa = da;
function fe(t) {
...
function Wt(t, e, r) {
  ...
  e = e || new (pa || FormData)(), r = p.toFlatObject(r, {
    metaTokens: !0,
    dots: !1,
    indexes: !1
  }, !1, function(v, y) {
  ...
  const o = r.metaTokens, a = r.visitor || m, i = r.dots, n = r.indexes, d = (r.Blob || typeof Blob < "u" && Blob) && ba(e);
  if (!p.isFunction(a))
  ...
  function m(b, v, y) {
    ...
    if (b && !y && typeof b == "object") {
      ...
      else if (p.isArray(b) && ca(b) || p.isFileList(b) || p.endsWith(v, "[]") && (x = p.toArray(b)))
        return v = Lr(v), x.forEach(function(A, $) {
          !(p.isUndefined(A) || A === null) && e.append(
            n === !0 ? er([v], $, i) : n === null ? v : v + "[]",
            l(A)
          );
        }), !1;
    }
    return fe(b) ? !0 : (e.append(er(y, v, i), l(b)), !1);
  }
  const c = [], g = Object.assign(ma, {
    defaultVisitor: m,
    convertValue: l,
    isVisitable: fe
  });
...
function Pr(t, e, r) {
  if (!e)
    return t;
  const o = r && r.encode || ga, a = r && r.serialize;
  let i;
  if (a ? i = a(e, r) : i = p.isURLSearchParams(e) ? e.toString() : new $e(e, r).toString(o), i) {
    const n = t.indexOf("#");
...
}, ua = typeof URLSearchParams < "u" ? URLSearchParams : $e, ha = FormData, va = (() => {
  let t;
  return typeof navigator < "u" && ((t = navigator.product) === "ReactNative" || t === "NativeScript" || t === "NS") ? !1 : typeof window < "u" && typeof document < "u";
})(), xa = (() => typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function")(), U = {
  isBrowser: !0,
  classes: {
    URLSearchParams: ua,
    FormData: ha,
...
function wa(t, e) {
  return Wt(t, new U.classes.URLSearchParams(), Object.assign({
    visitor: function(r, o, a, i) {
      return U.isNode && p.isBuffer(r) ? (this.append(o, r.toString("base64")), !1) : i.defaultVisitor.apply(this, arguments);
    }
  }, e));
}
function ya(t) {
...
function Br(t) {
  function e(r, o, a, i) {
    ...
    return n = !n && p.isArray(a) ? a.length : n, d ? (p.hasOwnProp(a, n) ? a[n] = [a[n], o] : a[n] = o, !s) : ((!a[n] || !p.isObject(a[n])) && (a[n] = []), e(r, o, a[n], i) && p.isArray(a[n]) && (a[n] = ka(a[n])), !s);
  }
...
const Kt = {
  ...
  transformRequest: [function(e, r) {
    ...
    if (i && p.isHTMLForm(e) && (e = new FormData(e)), p.isFormData(e))
      return a && a ? JSON.stringify(Br(e)) : e;
    ...
    return i || a ? (r.setContentType("application/json", !1), Da(e)) : e;
  }],
  transformResponse: [function(e) {
    const r = this.transitional || Kt.transitional, o = r && r.forcedJSONParsing, a = this.responseType === "json";
...
p.forEach(["post", "put", "patch"], function(e) {
  Kt.headers[e] = p.merge(Aa);
});
const _e = Kt, Ma = p.toObjectSet([
  "age",
  "authorization",
  "content-length",
  "content-type",
  ...
  return t && t.split(`
`).forEach(function(n) {
    a = n.indexOf(":"), r = n.substring(0, a).trim().toLowerCase(), o = n.substring(a + 1).trim(), !(!r || e[r] && Ma[r]) && (r === "set-cookie" ? e[r] ? e[r].push(o) : e[r] = [o] : e[r] = e[r] ? e[r] + ", " + o : o);
  }), e;
}, ar = Symbol("internals");
function vt(t) {
...
class Jt {
  ...
  set(e, r, o) {
    ...
    return p.isPlainObject(e) || e instanceof this.constructor ? n(e, r) : p.isString(e) && (e = e.trim()) && !Sa(e) ? n(za(e), r) : e != null && i(r, e, o), this;
  }
  get(e, r) {
    if (e = vt(e), e) {
  ...
  delete(e, r) {
    ...
    function i(n) {
      if (n = vt(n), n) {
        ...
        s && (!r || ir(o, o[s], s, r)) && (delete o[s], a = !0);
      }
    }
...
p.freezeMethods(Jt.prototype);
p.freezeMethods(Jt);
const R = Jt;
function ce(t, e) {
  const r = this || _e, o = e || r, a = R.from(o.headers);
  let i = o.data;
...
const _a = U.isStandardBrowserEnv ? function() {
  return {
...
function Yr(t, e) {
  return t && !Ca(e) ? Oa(t, e) : e;
}
const Ia = U.isStandardBrowserEnv ? function() {
...
const Ra = typeof XMLHttpRequest < "u", Pa = Ra && function(t) {
  return new Promise(function(r, o) {
    let a = t.data;
    const i = R.from(t.headers).normalize(), n = t.responseType;
    let s;
    function d() {
      t.cancelToken && t.cancelToken.unsubscribe(s), t.signal && t.signal.removeEventListener("abort", s);
    }
    p.isFormData(a) && (U.isStandardBrowserEnv || U.isStandardBrowserWebWorkerEnv) && i.setContentType(!1);
    ...
    l.open(t.method.toUpperCase(), Pr(m, t.params, t.paramsSerializer), !0), l.timeout = t.timeout;
    function c() {
      if (!l)
        return;
      const h = R.from(
    ...
    if ("onloadend" in l ? l.onloadend = c : l.onreadystatechange = function() {
      ...
      const h = (t.withCredentials || Ia(m)) && t.xsrfCookieName && _a.read(t.xsrfCookieName);
    ...
    }), p.isUndefined(t.withCredentials) || (l.withCredentials = !!t.withCredentials), n && n !== "json" && (l.responseType = t.responseType), typeof t.onDownloadProgress == "function" && l.addEventListener("progress", nr(t.onDownloadProgress, !0)), typeof t.onUploadProgress == "function" && l.upload && l.upload.addEventListener("progress", nr(t.onUploadProgress)), (t.cancelToken || t.signal) && (s = (h) => {
      !l || (o(!h || h.type ? new jt(null, t, l) : h), l.abort(), l = null);
    ...
    if (g && U.protocols.indexOf(g) === -1) {
      o(new w("Unsupported protocol " + g + ":", w.ERR_BAD_REQUEST, t));
      return;
    }
    l.send(a || null);
  });
...
const Fa = {
  getAdapter: (t) => {
    ...
    const { length: e } = t;
    let r, o;
    for (let a = 0; a < e && (r = t[a], !(o = p.isString(r) ? Ut[r.toLowerCase()] : r)); a++)
      ;
    if (!o)
      throw o === !1 ? new w(
        ...
        p.hasOwnProp(Ut, r) ? `Adapter '${r}' is not available in the build` : `Unknown adapter '${r}'`
      );
    if (!p.isFunction(o))
...
function sr(t) {
  return me(t), t.headers = R.from(t.headers), t.data = ce.call(
    t,
    t.transformRequest
  ), ["post", "put", "patch"].indexOf(t.method) !== -1 && t.headers.setContentType("application/x-www-form-urlencoded", !1), Fa.getAdapter(t.adapter || _e.adapter)(t).then(function(o) {
    return me(t), o.data = ce.call(
      t,
      t.transformResponse,
      o
    ), o.headers = R.from(o.headers), o;
  }, function(o) {
    return Qr(o) || (me(t), o && o.response && (o.response.data = ce.call(
      t,
      t.transformResponse,
      o.response
    ), o.response.headers = R.from(o.response.headers))), Promise.reject(o);
  });
}
const lr = (t) => t instanceof R ? t.toJSON() : t;
function pt(t, e) {
  e = e || {};
  const r = {};
  function o(l, m, c) {
  ...
  const d = {
    ...
    responseEncoding: n,
    validateStatus: s,
    headers: (l, m) => a(lr(l), lr(m), !0)
  };
  return p.forEach(Object.keys(t).concat(Object.keys(e)), function(m) {
    const c = d[m] || a, g = c(t[m], e[m], m);
    p.isUndefined(g) && c !== s || (r[m] = g);
  }), r;
}
const Hr = "1.2.2", Ce = {};
...
const dr = {};
Ce.transitional = function(e, r, o) {
  function a(i, n) {
    return "[Axios v" + Hr + "] Transitional option '" + i + "'" + n + (o ? ". " + o : "");
  }
  return (i, n, s) => {
    if (e === !1)
      throw new w(
    ...
    return r && !dr[n] && (dr[n] = !0, console.warn(
      a(
        n,
...
class Ft {
  ...
  request(e, r) {
    typeof e == "string" ? (r = r || {}, r.url = e) : r = e || {}, r = pt(this.defaults, r);
    const { transitional: o, paramsSerializer: a, headers: i } = r;
    o !== void 0 && ue.assertOptions(o, {
      silentJSONParsing: B.transitional(B.boolean),
      forcedJSONParsing: B.transitional(B.boolean),
      clarifyTimeoutError: B.transitional(B.boolean)
    }, !1), a !== void 0 && ue.assertOptions(a, {
      encode: B.function,
    ...
    let m, c = 0, g;
    if (!d) {
      const b = [sr.bind(this), void 0];
      for (b.unshift.apply(b, s), b.push.apply(b, l), g = b.length, m = Promise.resolve(r); c < g; )
        m = m.then(b[c++], b[c++]);
      return m;
    }
    g = s.length;
  ...
  getUri(e) {
    ...
    const r = Yr(e.baseURL, e.url);
    return Pr(r, e.params, e.paramsSerializer);
  }
}
p.forEach(["delete", "get", "head", "options"], function(e) {
  Ft.prototype[e] = function(r, o) {
...
p.forEach(["post", "put", "patch"], function(e) {
  ...
  Ft.prototype[e] = r(), Ft.prototype[e + "Form"] = r(!0);
});
const Lt = Ft;
class Oe {
  constructor(e) {
    ...
    this.promise.then((a) => {
      ...
      o.reason || (o.reason = new jt(i, n, s), r(o.reason));
    });
  }
  throwIfRequested() {
    if (this.reason)
...
const Va = he;
function Vr(t) {
  const e = new Lt(t), r = Sr(Lt.prototype.request, e);
  return p.extend(r, Lt.prototype, e, { allOwnKeys: !0 }), p.extend(r, e, null, { allOwnKeys: !0 }), r.create = function(a) {
    return Vr(pt(t, a));
  }, r;
}
const z = Vr(_e);
...
z.mergeConfig = pt;
z.AxiosHeaders = R;
z.formToJSON = (t) => Br(p.isHTMLForm(t) ? new FormData(t) : t);
z.HttpStatusCode = Va;
z.default = z;
const qa = z, xt = qa.create({
  baseURL: "https://54cb-2409-4070-4303-d425-a88d-43ca-7812-f7e5.in.ngrok.io/",
  headers: {
...
}, qr = (t) => "https://knit-dev-public.s3.ap-south-1.amazonaws.com/ui-auth-component/app_logos/short/" + t + ".svg", ve = (t) => "https://knit-dev-public.s3.ap-south-1.amazonaws.com/ui-auth-component/app_logos/full/" + t + ".svg", Y = (t) => "https://knit-dev-public.s3.ap-south-1.amazonaws.com/ui-auth-component/comp_logos/" + t + ".svg";
var Ja = Object.defineProperty, Ga = Object.getOwnPropertyDescriptor, Ie = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? Ga(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    ...
    return u`
      ...
      >
        <p class="category-panel-title mb-0">
          ${this.categoryKey.length ? Wa[this.categoryKey] : "Category Title"}
        </p>
      ...
      (t, e) => e <= 5 ? u`
          ...
          ${this.categoryData.length > 0 ? u`<p class="  more-text">
...
Ie([
  f()
], Mt.prototype, "categoryData", 2);
Ie([
  f({ type: String })
], Mt.prototype, "categoryKey", 2);
Mt = Ie([
  E("category-panel")
], Mt);
var Za = Object.defineProperty, Xa = Object.getOwnPropertyDescriptor, Wr = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? Xa(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
  ...
  render() {
    return u`
      <div class="category-selection-step-header">
        <p class="mb-0 category-selection-title">Select a category to integrate with</p>
      </div>
...
Wr([
  f()
], Bt.prototype, "categoryList", 2);
Bt = Wr([
  E("category-selection")
], Bt);
var ti = Object.defineProperty, ei = Object.getOwnPropertyDescriptor, Kr = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? ei(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
...
let xe = class extends D {
  ...
  render() {
    ...
    >
      <img src=${Y("loading")} alt="spinning" width="60" />
    </div>`;
  }
  createRenderRoot() {
    return this;
...
var ri = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, $t = (t, e, r, o) => {
    ...
    return u`
      ...
      <div class="input-group integration-selection-step-search">
        <span class="input-group-text" id="search-bar"
          ><img src=${Y("search")} alt="search"
        /></span>
        <input
          @input=${(t) => {
      Ka(this._onQueryChange(t), 2e3);
    }}
          placeholder="Search"
          class="form-control"
          aria-label="Search"
      ...
      (t, e) => u` <div
              ...
              key=${t.id + e}
              @click=${(r) => this._onIntegrationSelect(r, t.id)}
            >
              ${t.waitingEmail ? u`<div class="status">!</div>` : null}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ai = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, ii = (t) => (...e) => ({ _$litDirective$: t, values: e });
class ni {
  constructor(e) {
  }
  get _$AU() {
...
class we extends ni {
  constructor(e) {
    if (super(e), this.it = M, e.type !== ai.CHILD)
...
const et = ii(we);
var si = Object.defineProperty, li = Object.getOwnPropertyDescriptor, j = (t, e, r, o) => {
...
let S = class extends D {
  ...
  render() {
    return u` <div class="form-input-wrapper">
      <div class="form-input-header">
        <div class=" d-flex justify-content-between">
          ...
          ${this.tip ? u`<p
                ...
                >
                  ${this.tip.title}
                  <img class="ms-1" src=${Y("chevron")} alt="" />
                </p>` : null}
        </div>
        ${this.tip ? u`<div
                class="form-input-header-description ${this.tipHidden ? "" : "tip-show"}"
              >
                ${et(this.tip.description)}
              </div> ` : null}
        ${Gt(this.elementType, [
      [
        "TEXTBOX",
        () => u`<div class="input-group mb-3">
              ${this.prefix && this.prefix.length > 0 ? u`<span class="input-group-text"
                    >${et(this.prefix)}</span
                  >` : null}
              <input
                type="text"
              ...
              />
              ${this.suffix && this.suffix.length > 0 ? u`<span class="input-group-text"
                    >${et(this.suffix)}</span
                  >` : null}
            </div> `
      ],
      ...
      [
        ...
        () => {
          var t;
          return u`<div class="input-group mb-3">
              ${this.prefix && this.prefix.length > 0 ? u`<span class="input-group-text"
                    >${et(this.prefix)}</span
                  >` : null}
              <input
                ...
                aria-label="Enter your ${this.appLabel} ${this.label} "
              />
              ${((t = this.value) == null ? void 0 : t.length) > 0 ? u` <span
      ...
      [
        ...
        () => u`<select
            ...
            >
              ...
              ${Tt(
          this.optionData,
          (t) => u`<option class="form-select-option" value=${t.id}>
                      ${t.label} &nbsp;
                    </option>
                    <br />`
        )}
...
var di = Object.defineProperty, pi = Object.getOwnPropertyDescriptor, ft = (t, e, r, o) => {
...
let H = class extends D {
  constructor() {
    super(...arguments), this.setupDetails = [], this.formData = {}, this.submitDisabled = !1, this.appId = "", this.appData = {
      category: "HRIS",
      id: "knit",
      label: "Knit",
      logo: "",
    ...
    return u`
      <div class="form-setup-step">
        <div class="form-setup-step-header w-100 text-center">
          <img src=${ve(this.appData.id)} alt=${this.appData.label} />
        </div>
...
ft([
  f()
], H.prototype, "setupDetails", 2);
ft([
  f()
], H.prototype, "formData", 2);
ft([
  f({ type: Boolean })
], H.prototype, "submitDisabled", 2);
ft([
  f({ type: String })
], H.prototype, "appId", 2);
ft([
  f()
], H.prototype, "appData", 2);
H = ft([
  E("setup-form")
], H);
var ci = Object.defineProperty, mi = Object.getOwnPropertyDescriptor, Gr = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? mi(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
...
let ye = class extends D {
  ...
  render() {
    ...
    >
      <img src=${Y("awaiting")} alt="awaiting" width="96" />
      <p class="text-center w-100 mt-0">Awaiting authorization</p>
    </div>`;
  }
  createRenderRoot() {
    return this;
...
var bi = Object.defineProperty, gi = Object.getOwnPropertyDescriptor, Zt = (t, e, r, o) => {
...
let ct = class extends D {
  constructor() {
    super(...arguments), this.setupDetails = [], this.appId = "", this.appData = {
      category: "HRIS",
      id: "knit",
      label: "Knit",
      logo: "",
...
Zt([
  f()
], ct.prototype, "setupDetails", 2);
Zt([
  f({ type: String })
], ct.prototype, "appId", 2);
Zt([
  f()
], ct.prototype, "appData", 2);
ct = Zt([
  E("setup-oauth")
], ct);
var fi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, Zr = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? ui(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
...
let ke = class extends D {
  ...
  render() {
    ...
    >
      ...
      <button @click=${this._tryAgain}>Try again</button>
    </div>`;
  }
  _tryAgain() {
...
Zr([
  f()
], ke.prototype, "errorType", 2);
ke = Zr([
  E("tryagain-error")
], ke);
var hi = Object.defineProperty, vi = Object.getOwnPropertyDescriptor, I = (t, e, r, o) => {
...
let _ = class extends D {
  constructor() {
    super(...arguments), this.appData = {
      ...
      authType: "",
      setupSteps: []
    }, this.formStepData = [], this.oauthStepData = [], this.activeSetupStepIndex = 0, this.authSessionToken = "", this.stepDataLoaded = !1, this.submitDisabled = !1, this.integrationFailedError = !1, this.errorType = "unknown", this.stepType = null;
  }
  render() {
    return this.integrationFailedError ? u`<tryagain-error
    ...
    ]) : u`<loading-panel class="loading-panel" />`;
  }
  createRenderRoot() {
    return this;
  }
...
I([
  f()
], _.prototype, "appData", 2);
I([
  f()
], _.prototype, "formStepData", 2);
I([
  f()
], _.prototype, "oauthStepData", 2);
I([
  f({ type: Number })
...
I([
  f({ type: Boolean, state: !0 })
], _.prototype, "stepDataLoaded", 2);
I([
  f({ type: Boolean, state: !0 })
], _.prototype, "submitDisabled", 2);
I([
  f({ type: Boolean, state: !0 })
], _.prototype, "integrationFailedError", 2);
I([
  f({ type: String, state: !0 })
], _.prototype, "errorType", 2);
I([
  f()
], _.prototype, "stepType", 2);
_ = I([
  E("integration-setup")
], _);
var xi = Object.defineProperty, wi = Object.getOwnPropertyDescriptor, yi = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? wi(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
  return o && a && xi(e, r, a), a;
};
  ...
  render() {
    return u`
      ...
      <p class="err-description w-100 my-1 text-center"> Session token is either expired or invalid</p>
          <button @click=${this._forceExit}>Close and retry</button>
        </div>
      </div>
    `;
  }
...
var ki = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Xr = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? Ai(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
  return o && a && ki(e, r, a), a;
};
let Ae = class extends D {
  ...
  render() {
    return u` <div class="popup-header px-2 d-flex">
      <div class="header-left w-50  text-left align-items-center d-flex">
        ${this.showBackBtn ? u`
              <div class="d-flex cursor-pointer" @click="${this._backClick}">
                <img
                  src=${dt.exports() ? "https://knit-dev-public.s3.ap-south-1.amazonaws.com/ui-auth-component/back_phonepopup.svg" : "https://knit-dev-public.s3.ap-south-1.amazonaws.com/ui-auth-component/back_webpopup.svg"}
                  alt="<"
                />
      ...
      <div class="header-right w-50 text-right">
        <img
          ...
          src=${dt.exports() ? "https://knit-dev-public.s3.ap-south-1.amazonaws.com/ui-auth-component/close_phonepopup.svg" : "https://knit-dev-public.s3.ap-south-1.amazonaws.com/ui-auth-component/close_webpopup.svg"}
          alt="Close"
        />
      </div>
    </div>`;
...
Xr([
  f({ type: Boolean })
], Ae.prototype, "showBackBtn", 2);
Ae = Xr([
  E("popup-header")
], Ae);
var Di = Object.defineProperty, Mi = Object.getOwnPropertyDescriptor, to = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? Mi(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
  return o && a && Di(e, r, a), a;
};
let De = class extends D {
  ...
  render() {
    return u`<div
      class="full-panel px-4 py-4 flex-wrap d-flex justify-content-center align-items-center"
    >
      <img src=${Y("successful")} alt="success" width="96" />
...
function cr(t, e, r) {
  ...
  const i = o.x + o.width / 2 - a.width / 2, n = o.y + o.height / 2 - a.height / 2, s = Xt(e), d = ro(s), l = o[d] / 2 - a[d] / 2, m = ut(e), c = s === "x";
  let g;
  switch (m) {
    case "top":
      g = {
...
const ji = async (t, e, r) => {
  ...
  for (let v = 0; v < s.length; v++) {
    ...
    if (m = k != null ? k : m, c = A != null ? A : c, h = {
      ...h,
      [y]: {
        ...h[y],
        ...$
      ...
      b++, typeof N == "object" && (N.placement && (g = N.placement), N.rects && (l = N.rects === !0 ? await n.getElementRects({
        reference: t,
        floating: e,
        strategy: a
      }) : N.rects), {
...
async function oo(t, e) {
  ...
  const {
    ...
    altBoundary: g = !1,
    padding: h = 0
  } = e, b = $i(h), y = s[g ? c === "floating" ? "reference" : "floating" : c], x = Qt(await i.getClippingRect({
    ...
    x: o,
    y: a
  } : n.reference, A = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(s.floating)), $ = await (i.isElement == null ? void 0 : i.isElement(A)) ? await (i.getScale == null ? void 0 : i.getScale(A)) || {
    x: 1,
    y: 1
  } : {
    x: 1,
    y: 1
  }, N = Qt(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({
    rect: k,
    offsetParent: A,
    strategy: d
  }) : k);
  return process.env.NODE_ENV, {
    top: (x.top - N.top + b.top) / $.y,
    bottom: (N.bottom - x.bottom + b.bottom) / $.y,
    left: (x.left - N.left + b.left) / $.x,
    right: (N.right - x.right + b.right) / $.x
  };
}
const _i = Math.min, Ci = Math.max;
function mr(t, e, r) {
  return Ci(t, _i(e, r));
}
const Oi = ["top", "right", "bottom", "left"], br = /* @__PURE__ */ Oi.reduce((t, e) => t.concat(e, e + "-start", e + "-end"), []), Ii = {
  left: "right",
  right: "left",
  bottom: "top",
  top: "bottom"
...
function gr(t) {
  return t.replace(/left|right|bottom|top/g, (e) => Ii[e]);
}
function Ui(t, e, r) {
  r === void 0 && (r = !1);
  const o = at(t), a = Xt(t), i = ro(a);
  let n = a === "x" ? o === (r ? "end" : "start") ? "right" : "left" : o === "start" ? "bottom" : "top";
  return e.reference[i] > e.floating[i] && (n = gr(n)), {
    main: n,
    cross: gr(n)
  };
}
...
function Pi(t, e, r) {
  return (t ? [...r.filter((a) => at(a) === t), ...r.filter((a) => at(a) !== t)] : r.filter((a) => ut(a) === a)).filter((a) => t ? at(a) === t || (e ? Ri(a) !== a : !1) : !0);
}
const Fi = function(t) {
  return t === void 0 && (t = {}), {
    name: "autoPlacement",
    ...
    async fn(e) {
      ...
      const {
        ...
        alignment: m,
        allowedPlacements: c = br,
        autoAlignment: g = !0,
        ...h
      } = t, b = m !== void 0 || c === br ? Pi(m || null, g, c) : c, v = await oo(e, h), y = ((r = n.autoPlacement) == null ? void 0 : r.index) || 0, x = b[y];
      if (x == null)
        return {};
      const {
        main: k,
      ...
      const $ = [v[ut(x)], v[k], v[A]], N = [...((o = n.autoPlacement) == null ? void 0 : o.overflows) || [], {
        placement: x,
        overflows: $
      }], Re = b[y + 1];
      if (Re)
      ...
      const Pe = N.slice().sort((oe, ae) => oe.overflows[0] - ae.overflows[0]), Fe = ((a = Pe.find((oe) => {
        let {
          overflows: ae
        } = oe;
        return ae.every((fo) => fo <= 0);
      })) == null ? void 0 : a.placement) || Pe[0].placement;
      return Fe !== s ? {
        data: {
          index: y + 1,
          overflows: N
...
async function Bi(t, e) {
  const {
    ...
    platform: o,
    elements: a
  } = t, i = await (o.isRTL == null ? void 0 : o.isRTL(a.floating)), n = ut(r), s = at(r), d = Xt(r) === "x", l = ["left", "top"].includes(n) ? -1 : 1, m = i && d ? -1 : 1, c = typeof e == "function" ? e(t) : e;
  let {
    mainAxis: g,
    crossAxis: h,
    alignmentAxis: b
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        x: r,
        y: o
      }, m = await oo(e, d), c = Xt(ut(a)), g = Yi(c);
      let h = l[c], b = l[g];
      if (i) {
        const y = c === "y" ? "top" : "left", x = c === "y" ? "bottom" : "right", k = h + m[y], A = h - m[x];
        h = mr(k, h, A);
      }
      if (n) {
        const y = g === "y" ? "top" : "left", x = g === "y" ? "bottom" : "right", k = b + m[y], A = b - m[x];
        b = mr(k, b, A);
      }
      const v = s.fn({
        ...e,
...
function V(t) {
  return io(t) ? (t.nodeName || "").toLowerCase() : "";
}
let _t;
function ao() {
  if (_t)
...
function P(t) {
  return t instanceof C(t).HTMLElement;
}
function q(t) {
  return t instanceof C(t).Element;
}
function io(t) {
  return t instanceof C(t).Node;
}
function fr(t) {
...
function Ue(t) {
  const e = /firefox/i.test(ao()), r = L(t), o = r.backdropFilter || r.WebkitBackdropFilter;
...
const ur = Math.min, wt = Math.max, Yt = Math.round;
function so(t) {
  const e = L(t);
...
function zt(t, e, r, o) {
  ...
  const n = t.getBoundingClientRect(), s = lo(t);
  let d = po;
  e && (o ? q(o) && (d = it(o)) : d = it(t));
  const l = s ? C(s) : window, m = !no() && r;
  let c = (n.left + (m && ((a = l.visualViewport) == null ? void 0 : a.offsetLeft) || 0)) / d.x, g = (n.top + (m && ((i = l.visualViewport) == null ? void 0 : i.offsetTop) || 0)) / d.y, h = n.width / d.x, b = n.height / d.y;
  if (s) {
    const v = C(s), y = o && q(o) ? C(o) : o;
    let x = v.frameElement;
    for (; x && o && y !== v; ) {
      const k = it(x), A = x.getBoundingClientRect(), $ = getComputedStyle(x);
      A.x += (x.clientLeft + parseFloat($.paddingLeft)) * k.x, A.y += (x.clientTop + parseFloat($.paddingTop)) * k.y, c *= k.x, g *= k.y, h *= k.x, b *= k.y, c += A.x, g += A.y, x = C(x).frameElement;
    }
  }
  return {
    width: h,
...
function co(t) {
  return zt(K(t)).left + ee(t).scrollLeft;
}
function qi(t, e, r) {
  const o = P(e), a = K(e), i = zt(t, !0, r === "fixed", e);
  let n = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function Et(t) {
  if (V(t) === "html")
    return t;
  const e = t.assignedSlot || t.parentNode || (fr(t) ? t.host : null) || K(t);
  return fr(e) ? e.host : e;
}
function hr(t) {
  return !P(t) || L(t).position === "fixed" ? null : t.offsetParent;
}
function Wi(t) {
  let e = Et(t);
  for (; P(e) && !Le(e); ) {
...
function vr(t) {
  const e = C(t);
  let r = hr(t);
  for (; r && Vi(r) && L(r).position === "static"; )
    r = hr(r);
  return r && (V(r) === "html" || V(r) === "body" && L(r).position === "static" && !Ue(r)) ? e : r || Wi(t) || e;
}
function Ki(t) {
  return so(t);
}
function Ji(t) {
  ...
  if ((a || !a && o !== "fixed") && ((V(r) !== "body" || te(i)) && (n = ee(r)), P(r))) {
    const l = zt(r);
    s = it(r), d.x = l.x + r.clientLeft, d.y = l.y + r.clientTop;
  }
  return {
    width: e.width * s.x,
    height: e.height * s.y,
...
function Gi(t, e) {
  const r = C(t), o = K(t), a = r.visualViewport;
...
function Zi(t) {
  var e;
  const r = K(t), o = ee(t), a = (e = t.ownerDocument) == null ? void 0 : e.body, i = wt(r.scrollWidth, r.clientWidth, a ? a.scrollWidth : 0, a ? a.clientWidth : 0), n = wt(r.scrollHeight, r.clientHeight, a ? a.scrollHeight : 0, a ? a.clientHeight : 0);
  let s = -o.scrollLeft + co(t);
  const d = -o.scrollTop;
  return L(a || r).direction === "rtl" && (s += wt(r.clientWidth, a ? a.clientWidth : 0) - i), {
    width: i,
    height: n,
    x: s,
    y: d
...
function mo(t) {
  const e = Et(t);
  return Le(e) ? t.ownerDocument.body : P(e) && te(e) ? e : mo(e);
}
function bo(t, e) {
  var r;
  e === void 0 && (e = []);
  const o = mo(t), a = o === ((r = t.ownerDocument) == null ? void 0 : r.body), i = C(o);
  return a ? e.concat(i, i.visualViewport || [], te(o) ? o : []) : e.concat(o, bo(o));
}
function Xi(t, e) {
  const r = zt(t, !0, e === "fixed"), o = r.top + t.clientTop, a = r.left + t.clientLeft, i = P(t) ? it(t) : {
    x: 1,
    y: 1
...
function xr(t, e, r) {
  return e === "viewport" ? Qt(Gi(t, r)) : q(e) ? Xi(e, r) : Qt(Zi(K(t)));
}
function tn(t, e) {
  const r = e.get(t);
  if (r)
    return r;
  let o = bo(t).filter((s) => q(s) && V(s) !== "body"), a = null;
  const i = L(t).position === "fixed";
  let n = i ? Et(t) : t;
  for (; q(n) && !Le(n); ) {
    const s = L(n), d = Ue(n);
    (i ? !d && !a : !d && s.position === "static" && !!a && ["absolute", "fixed"].includes(a.position)) ? o = o.filter((m) => m !== n) : a = s, n = Et(n);
  }
  return e.set(t, o), o;
}
function en(t) {
  ...
  const n = [...r === "clippingAncestors" ? tn(e, this._c) : [].concat(r), o], s = n[0], d = n.reduce((l, m) => {
    const c = xr(e, m, a);
    return l.top = wt(c.top, l.top), l.right = ur(c.right, l.right), l.bottom = ur(c.bottom, l.bottom), l.left = wt(c.left, l.left), l;
  }, xr(e, s, a));
  return {
...
const rn = {
  ...
  async getElementRects(t) {
    ...
    const a = this.getOffsetParent || vr, i = this.getDimensions;
    return {
      reference: qi(e, await a(r), o),
      floating: {
        x: 0,
        y: 0,
        ...await i(r)
...
var an = Object.defineProperty, nn = Object.getOwnPropertyDescriptor, go = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? nn(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
  return o && a && an(e, r, a), a;
};
const wr = ["pointerenter", "focus"], yr = ["pointerleave", "blur", "keydown", "click"];
let Ht = class extends D {
  constructor() {
    super(...arguments), this.offset = 4, this._target = null, this.show = () => {
      this.style.cssText = "", on(this.target, this, {
        strategy: "fixed",
        middleware: [
          Qi(0),
          Hi(),
          Fi({ allowedPlacements: ["top", "bottom"] })
        ]
      }).then(({ x: t, y: e }) => {
  ...
  set target(t) {
    this.target && (wr.forEach(
      (e) => this.target.removeEventListener(e, this.show)
    ), yr.forEach(
      (e) => this.target.removeEventListener(e, this.hide)
    )), t && (wr.forEach((e) => t.addEventListener(e, this.show)), yr.forEach((e) => t.addEventListener(e, this.hide))), this._target = t;
  }
  connectedCallback() {
    var t;
...
go([
  f({ type: Number })
], Ht.prototype, "offset", 2);
Ht = go([
  E("simple-tooltip")
], Ht);
var sn = Object.defineProperty, ln = Object.getOwnPropertyDescriptor, tt = (t, e, r, o) => {
...
let W = class extends D {
  constructor() {
    super(...arguments), this.appData = {
      ...
      authType: "",
      setupSteps: []
    }, this.checkStep = 0, this.sendingEmail = !1, this.sendError = !1, this.authSessionToken = "", this.adminEmail = "";
  }
  connectedCallback() {
  ...
  render() {
    return u`
            ...
            <div class="admin-check-step-content px-4">
              ...
              >
                ...
                <div class="d-flex justify-content-center align-items-center">
                  ...
                  <img class="mx-1" src=${Ni} alt="info" height="12" />
                </div>
              </div>
            </div>`
      ],
      [
        2,
        () => u`${this.sendError ? u`<tryagain-error />` : u`<email-sent
                  class="full-panel"
...
tt([
  f({ type: Number })
], W.prototype, "checkStep", 2);
tt([
  f({ type: Boolean })
], W.prototype, "sendingEmail", 2);
tt([
  f({ type: Boolean })
], W.prototype, "sendError", 2);
tt([
  f({ type: String })
], W.prototype, "authSessionToken", 2);
tt([
  f({ type: String })
], W.prototype, "adminEmail", 2);
W = tt([
  E("admin-check")
], W);
var dn = Object.defineProperty, pn = Object.getOwnPropertyDescriptor, O = (t, e, r, o) => {
...
let T = class extends D {
  constructor() {
    super(...arguments), this.step = 0, this.activeSetupStepIndex = 0, this.authSessionToken = "", this.adminMode = !1, this.appsDataLoaded = !1, this.appsData = {}, this.appsApiError = !1, this.tokenError = !1, this.integrationSuccess = !1, this.selectedCategory = "", this.selectedApp = {
      category: "",
      id: "",
      setupSteps: [],
      label: "",
  ...
  render() {
    ...
    return u`
      <div class="dialog-wrapper" role="dialog">
        <div
          class=${dt.exports() ? "popup-container" : "popup-container popup-web"}
        >
          ${this.integrationSuccess ? u`<auth-success class="full-panel" />` : this.appsDataLoaded ? this.tokenError ? u`
                  <token-error
                    class="full-panel"
                    @forceExit=${this._forceExit}
                  />
                ` : this.appsApiError ? u`<tryagain-error
                  class="full-panel"
                  .errorType=${"unknown"}
                  @tryAgain=${this._resetAppsApiError}
                ></tryagain-error>` : u`
                  ${this.step == 3 && this.selectedApp.id.length && ((t = this.selectedApp.setupSteps[this.activeSetupStepIndex]) == null ? void 0 : t.setupType) == "OAUTH" ? null : u` <popup-header
      ...
      [
        2,
        () => u`<admin-check class="admin-check-setup"
  ...
  _prevStep(t) {
    t == null || t.preventDefault(), this.step !== 3 ? this.step = this.step - 1 : this.step = this.step - 2;
  }
  _updateAppData(t) {
    t == null || t.preventDefault();
  ...
  _forceExit(t) {
    this._togglePopup(t), this._refreshAccess(t);
  }
  _back(t) {
    t == null || t.preventDefault(), this.step > 0 && this._prevStep();
  }
  _backForce(t) {
    t == null || t.preventDefault(), this.step > 0 && this._prevStep(), this.selectedApp = {
      category: "",
      id: "",
      setupSteps: [],
      label: "",
...
var cn = Object.defineProperty, mn = Object.getOwnPropertyDescriptor, re = (t, e, r, o) => {
...
let mt = class extends D {
  constructor() {
    super(...arguments), this.authSessionToken = "", this.adminMode = !1, this.popupEnabled = !1;
  }
  render() {
    return u`
      <div class="component-wrapper">
        ${this.popupEnabled ? u`
              ...
              ></knit-popup>
            ` : ""}
        ${u`<slot name="initiator" @click=${this._onInitiatorClick}></slot>`}
      </div>
    `;
  }
  _onInitiatorClick(t) {
  ...
  _onIntegrationSuccess(t) {
    t.preventDefault(), console.log("event emitted in knit auth"), this.popupEnabled = !1;
  ...
  updated(t) {
    t.has("adminMode") && this.adminMode && (console.log("adminMode changed"), this._onInitiatorClick());
  }
};
mt.styles = [
  Ar(jo),
...
re([
  f({ type: String, attribute: !0 })
], mt.prototype, "authSessionToken", 2);
re([
  f({ type: Boolean, attribute: !0 })
], mt.prototype, "adminMode", 2);
re([
  f({ type: Boolean, state: !0 })
], mt.prototype, "popupEnabled", 2);
mt = re([
  E("knit-auth")
], mt);
export {
